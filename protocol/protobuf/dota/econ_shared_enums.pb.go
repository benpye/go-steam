...
var file_econ_shared_enums_proto_goTypes = []interface{}{
	...
	(EGCPartnerRequestResponse)(0), // 2: dota.EGCPartnerRequestResponse
	(EGCMsgUseItemResponse)(0),     // 3: dota.EGCMsgUseItemResponse
	(*CMsgGenericResult)(nil),      // 4: dota.CMsgGenericResult
}
